...
class _WishListState extends State<WishList> {
  ...
  Future<void> _fetchFavouritesAndProducts() async {
    ...
    if (wishList.favouriteIds.isNotEmpty) {
      try {
        final products = await ProductService.fetchProductsByIds(wishList.favouriteIds);
        setState(() {
          _products = products;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: wishList.isLoading || _isLoadingProducts
              ...
              child: Card(
                ...
                child: Stack(
                  children: [
                          ...
                          child: ClipRRect(
                            ...
                            child: product.images.isNotEmpty
                              ...
                              errorBuilder: (context, error, stackTrace) =>
                                  Image.asset('assets/images/asus.png', fit: BoxFit.cover),
                            )
                                : Image.asset('assets/images/asus.png', fit: BoxFit.cover),
                          ),
                        ),
                    ...
                    // Nút xóa fixed góc trên phải với icon mới (ví dụ: Icons.highlight_remove_rounded)
                    Positioned(
                      top: 8,
                      right: 8,
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.highlight_remove_rounded, color: Colors.red, size: 22),
                        ),
                      ),
                    ),
                  ],
